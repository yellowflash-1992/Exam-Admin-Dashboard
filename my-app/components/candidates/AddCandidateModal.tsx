...
const handleClose = () => {
 ...
 <form onSubmit={handleSubmit}>
  ...
  <div className="grid grid-cols-2 gap-4">
    ...
    <div className="space-y-2">
      ...
      />
        ...
        {errors.score && (
  <p className="text-xm text-red-500">
    {errors.score}
  </p>
)}
    </div>
  ...
  className="w-full rounded-xl border border-[var(--border)] bg-[var(--card)] px-4 resize-none 
...
/>
  ...
  type="button"
  onClick={handleClose}
  className="rounded-xl border border-[var(--border)] px-3 py-2 hover:bg-[var(--muted)] text-sm transition"
>
  Cancel
</button>
